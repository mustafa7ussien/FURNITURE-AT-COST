...
@Component({
  selector: 'app-right-blog-details',
  templateUrl: './right-blog-details.component.html',
  styleUrls: ['./right-blog-details.component.scss']
})
export class RightBlogDetailsComponent implements OnInit {
